...
//   Future<void> getImage(BuildContext context, String myUserName,
//       String myPicture, String chatRoomId) async {
//     var image = await _picker.pickImage(source: ImageSource.gallery);
//     if (image != null) {
//       selectedImage = File(image.path);
//       await _uploadImage(context, myUserName, myPicture, chatRoomId);
//     }
//   }

//   Future<void> _uploadImage(BuildContext context, String myUserName,
//       String myPicture, String chatRoomId) async {
//     try {
...
//       final fileName = '${const Uuid().v4()}${extension(imageFile.path)}';

//       final storageResponse = await supabase.storage
//           .from('chat-media') // Your Supabase bucket name
//           .upload('images/$fileName', imageFile);

//       final publicUrl =
//           supabase.storage.from('chat-media').getPublicUrl('images/$fileName');
...
//   Future<void> _startRecording(BuildContext context, String myUserName,
//       String myPicture, String chatRoomId) async {
//     await _recorder.startRecorder(toFile: _filePah);
//     setState(() {
//       isRecording = true;
//       Navigator.pop(context);
//       openRecording(context, myUserName, myPicture, chatRoomId);
//     });
//   }

//   Future<void> _stopRecording(BuildContext context, String myUserName,
//       String myPicture, String chatRoomId) async {
...
//   Future openRecording(BuildContext context, String myUserName,
//           String myPicture, String chatRoomId) =>
//       showDialog(
//           context: context,
...
//                               if (isRecording) {
//                                 _stopRecording(
//                                     context, myUserName, myPicture, chatRoomId);
//                               } else {
//                                 _startRecording(
//                                     context, myUserName, myPicture, chatRoomId);
//                               }
...
//   Future<void> _uploadFile(BuildContext context, String myUserName,
//       String myPicture, String chatRoomId) async {
